...
export type IStadeState = IPaginationBaseState;

export class Stade extends React.Component<IStadeProps, IStadeState> {
  state: IStadeState = {
  ...
  render() {
    const { stadeList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="stade-heading">
          Stades
        ...
        <div className="table-responsive">
          {stadeList && stadeList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('codePostal')}>
                    Code Postal <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('ville')}>
                  ...
                  <tr key={`entity-${i}`}>
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`${match.url}/${stade.id}/edit`} color="primary" size="sm">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Edit</span>
                        </Button>
                        <Button tag={Link} to={`${match.url}/${stade.id}/delete`} color="danger" size="sm">
            ...
            <div className="alert alert-warning">No Stades found</div>
          )}
        </div>
