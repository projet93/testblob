...
export type IReferentState = IPaginationBaseState;

export class Referent extends React.Component<IReferentProps, IReferentState> {
  state: IReferentState = {
  ...
  render() {
    const { referentList, match, totalItems } = this.props;
    return (
      <div>
        ...
        <div className="table-responsive">
          {referentList && referentList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('licence')}>
                  ...
                  <tr key={`entity-${i}`}>
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`${match.url}/${referent.id}/edit`} color="primary" size="sm">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Edit</span>
                        </Button>
                        <Button tag={Link} to={`${match.url}/${referent.id}/delete`} color="danger" size="sm">
            ...
            <div className="alert alert-warning">No Referents found</div>
          )}
        </div>
